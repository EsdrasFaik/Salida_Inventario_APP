...
const HomeSalidas = () => {
    ...
    const opcionesEstado = [
        { value: "", label: "Todos" },
        { value: "Enviada a sucursal", label: "Enviada a sucursal" },
    ...
    const handleRecibir = (salida) => {
        if (salida.estado !== "Enviada a sucursal") return mostraAlertaError("Solo se pueden recibir salidas en estado 'Enviada a sucursal'.");
        mostraAlertaPregunta(
            async (confirmado) => {
    ...
    const colorEstado = (estado) => {
        if (estado === "Enviada a sucursal") return "bg-primary";
        if (estado === "Recibida") return "bg-success";
        if (estado === "Anulada") return "bg-danger";
        return "bg-secondary";
    };

    console.log("salida estado:", salidasPaginadas[0]?.estado);
    console.log("estado length:", salidasPaginadas[0]?.estado?.length);
    console.log("match:", salidasPaginadas[0]?.estado === "Enviada a sucursal");
    console.log("sucursalDestinoId:", salidasPaginadas[0]?.sucursalDestinoId, typeof salidasPaginadas[0]?.sucursalDestinoId);
    console.log("usuario.sucursalId:", usuario?.sucursalId, typeof usuario?.sucursalId);
    return (
                ...
                <div className="hs-resumen">
                    ...
                    <div className="hs-resumen-item">
                        <div className="hs-resumen-valor" style={{ color: "#2563eb" }}>
                            {salidasFiltradas.filter(s => s.estado === "Enviada a sucursal").length}
                        </div>
                                        ...
                                        >
                                            ...
                                            <td onClick={e => e.stopPropagation()}>
                                                <div className="hs-actions">
                                                    {salida.sucursalDestinoId === usuario?.sucursalId && salida.estado === "Enviada a sucursal" && (
                                                        <button
                                                    ...
                                                    {esJefeBodega && salida.sucursalOrigenId === usuario?.sucursalId && salida.estado === "Enviada a sucursal" && (
                                                        <button
